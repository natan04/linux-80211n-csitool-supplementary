...
[tamper_history, environemnt_history, history, samples_s] = receive_csi_live(ports,tamper_history_size,enviornment_move_size, history_length, sum_samples);
...
%     parfor i=1:number_of_receivers
%         distance_set_enviornment{i} = graph_distance_from_history(history(i,:),environemnt_history(i,:)); 
%     end
end
...
%    path_cur = sprintf('%s/%s',datestr(datetime('today')), cur);
    ...
    mkdir(path_cur);
    %save(name_file,'tamper_history', 'distance_set_enviornment', 'environemnt_history', 'samples_s','history', 'thresholds_max', 'thresholds_mean', 'distance_set','path_cur','number_of_receivers');
    save(name_file,'tamper_history', 'environemnt_history', 'samples_s','history', 'thresholds_max', 'thresholds_mean', 'distance_semaples_from_history','path_cur','number_of_receivers');
